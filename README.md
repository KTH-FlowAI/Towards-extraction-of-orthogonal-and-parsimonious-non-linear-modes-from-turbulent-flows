...
All the training parameters are defined in the [train_config](https://github.com/Fantasy98 Towards-extraction-of-orthogonal-and-parsimonious-non-linear-modes-from-turbulent-flows.git/config/train_config.py) 
